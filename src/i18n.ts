...
export const UI = {
  en: {
    ...
    editorSavedToFile: 'Saved to game file',
    editorSaveFailedFile: 'Save failed — is the editor server running?',
    ...
    editorBgDeepJungle: 'Misty jungle (layered art)',
    editorSpriteSet: 'Sprite set',
    editorSpriteSetDay: 'Day',
    editorSpriteSetNight: 'Night (30% darker)',
    editorSpriteGroupDay: 'Day sprites',
    editorSpriteGroupNight: 'Night sprites',
  ...
  cs: {
    ...
    editorSavedToFile: 'Uloženo do souboru hry',
    editorSaveFailedFile: 'Uložení selhalo — běží server editoru?',
    ...
    editorBgDeepJungle: 'Mlžná džungle (vrstvená grafika)',
    editorSpriteSet: 'Sada spritů',
    editorSpriteSetDay: 'Denní',
    editorSpriteSetNight: 'Noční (o 30 % tmavší)',
    editorSpriteGroupDay: 'Denní sprity',
    editorSpriteGroupNight: 'Noční sprity',
